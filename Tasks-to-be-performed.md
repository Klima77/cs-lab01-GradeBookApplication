...
- [ ] Add support for Ranked Grading		zrobione
	...
	- [ ] Creating the `StandardGradeBook` class		zrobione
		...
		- [ ] Create a constructor for `StandardGradeBook`		zrobione
	...
	- [ ] Override `RankedGradeBook`'s `CalculateStatistics` method zrobion
